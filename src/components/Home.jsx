        ...
        <>
            <div className="p-2">
                <div className="flex justify-between md:flex-row flex-col items-start gap-4">
                    ...
                    <div className="flex flex-col gap-5 p-6 w-full  md:w-3/12 justify-start items-start bg-white dark:bg-gray-800 dark:text-gray-200 shadow-lg rounded-lg md:p-6">
