...
const Payments = ({ paymentMethod, image = true, width = 30, text = true }) => {

    switch (paymentMethod) {
        case "card":
            return (
                <div className='flex gap-2 box text-green-500'>
                    {text ? "Karta orqali" : ""}

                    {
                        image && <svg xmlns="http://www.w3.org/2000/svg" width={width} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        case "debit":
            return (
                <div className='flex gap-2 box text-red-500'>
                    {text ? "Qarz" : ""}
                    {
                        image && <svg xmlns="http://www.w3.org/2000/svg" width={width} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
